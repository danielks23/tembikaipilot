...
static std::map<std::string, service> services = {
  ...
  { "uiPlan", {"uiPlan", 8052, true, 20, 40}},
  { "qRoadEncodeIdx", {"qRoadEncodeIdx", 8053, false, 20, -1}},
  { "userFlag", {"userFlag", 8054, true, 0, 1}},
  { "microphone", {"microphone", 8055, true, 10, 10}},
  { "settings", {"settings", 8056, true, 10, -1}},
  { "uiDebug", {"uiDebug", 8057, true, 0, 1}},
  { "testJoystick", {"testJoystick", 8058, true, 0, -1}},
  { "roadEncodeData", {"roadEncodeData", 8059, false, 20, -1}},
  { "driverEncodeData", {"driverEncodeData", 8060, false, 20, -1}},
  { "wideRoadEncodeData", {"wideRoadEncodeData", 8061, false, 20, -1}},
  { "qRoadEncodeData", {"qRoadEncodeData", 8062, false, 20, -1}},
  { "livestreamWideRoadEncodeIdx", {"livestreamWideRoadEncodeIdx", 8063, false, 20, -1}},
  { "livestreamRoadEncodeIdx", {"livestreamRoadEncodeIdx", 8064, false, 20, -1}},
  { "livestreamDriverEncodeIdx", {"livestreamDriverEncodeIdx", 8065, false, 20, -1}},
  { "livestreamWideRoadEncodeData", {"livestreamWideRoadEncodeData", 8066, false, 20, -1}},
  { "livestreamRoadEncodeData", {"livestreamRoadEncodeData", 8067, false, 20, -1}},
  { "livestreamDriverEncodeData", {"livestreamDriverEncodeData", 8068, false, 20, -1}},
  { "customReservedRawData0", {"customReservedRawData0", 8069, true, 0, -1}},
  { "customReservedRawData1", {"customReservedRawData1", 8070, true, 0, -1}},
  { "customReservedRawData2", {"customReservedRawData2", 8071, true, 0, -1}},
};
#endif
