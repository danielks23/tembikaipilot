...
from openpilot.common.transformations.camera import ka2_f_frame_size, ka2_d_frame_size, ka2_e_frame_size, eon_f_frame_size, eon_d_frame_size

VideoStreamMeta = namedtuple("VideoStreamMeta", ["camera_state", "encode_index", "stream", "dt", "frame_sizes"])
ROAD_CAMERA_FRAME_SIZES = {"ka2": ka2_f_frame_size, "neo": eon_f_frame_size}
WIDE_ROAD_CAMERA_FRAME_SIZES = {"ka2": ka2_e_frame_size}
DRIVER_FRAME_SIZES = {"ka2": ka2_d_frame_size, "neo": eon_d_frame_size}
