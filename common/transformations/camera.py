...
ka2_f_focal_length = 2648.0
ka2_e_focal_length = ka2_d_focal_length = 567.0 # probably wrong? magnification is not consistent across frame

eon_f_frame_size = (1164, 874)
eon_d_frame_size = (816, 612)
ka2_f_frame_size = ka2_e_frame_size = ka2_d_frame_size = (1928, 1208)
...
ka2_fcam_intrinsics = np.array([
  [ka2_f_focal_length,  0.0,  float(ka2_f_frame_size[0])/2],
  [0.0,  ka2_f_focal_length,  float(ka2_f_frame_size[1])/2],
  [0.0,  0.0,                                            1.0]])

ka2_dcam_intrinsics = np.array([
  [ka2_d_focal_length,  0.0,  float(ka2_d_frame_size[0])/2],
  [0.0,  ka2_d_focal_length,  float(ka2_d_frame_size[1])/2],
  [0.0,  0.0,                                            1.0]])

ka2_ecam_intrinsics = ka2_dcam_intrinsics

# aka 'K_inv' aka view_frame_from_camera_frame
eon_fcam_intrinsics_inv = np.linalg.inv(eon_fcam_intrinsics)
eon_intrinsics_inv = eon_fcam_intrinsics_inv # xx

ka2_fcam_intrinsics_inv = np.linalg.inv(ka2_fcam_intrinsics)
ka2_ecam_intrinsics_inv = np.linalg.inv(ka2_ecam_intrinsics)


FULL_FRAME_SIZE = ka2_f_frame_size
FOCAL = ka2_f_focal_length
fcam_intrinsics = ka2_fcam_intrinsics
